...
Hubble AI Trading Frontend 是一个为 AI 交易平台构建的现代化全栈开源前端系统。基于 React Router 7、Cloudflare Workers 和 D1 数据库构建，为 AI 驱动交易策略提供全面的交易分析、智能订单管理和实时投资组合追踪功能。
...
详细说明参见 [`app/features/README.md`](app/features/README.md)。
...
- [功能模块指南](app/features/README.md) - 功能模块化开发规范
- [订单功能](app/features/order/README.md) - 订单管理系统
- [图表功能](app/features/client.chart/README.md) - 图表可视化
