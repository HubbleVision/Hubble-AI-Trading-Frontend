...
export const authenticate = async (
  ...
  // Method 2: Use existing session validation logic
  ...
  // Validate session using enhanced version to get detailed results
